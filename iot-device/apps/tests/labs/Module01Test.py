import unittest
from labs.module01.SystemPerformanceAdaptor import *
...
class Module01Test(unittest.TestCase):
	...
	"""
	This function is used to check the values of cpuutil and memutil, if they are in the range(0.0,100.0)
	"""
	def testValue(self):
		...
		self.assertGreaterEqual(cpuUtil, 0.0)
		self.assertLessEqual(cpuUtil, 100.0)
		self.assertGreaterEqual(memUtil, 0.0)
		self.assertLessEqual(memUtil, 100.0)
